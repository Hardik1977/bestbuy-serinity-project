package bestbuy.serenity.project.model;
...
public class ProductsPojo {
    ...
    public static ProductsPojo getProductsPojo(String name, String type, Double price, String upc, Integer shipping, String description, String manufacturer, String model, String url) {
